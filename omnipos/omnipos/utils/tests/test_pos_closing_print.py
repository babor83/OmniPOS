...
from omnipos.omnipos.utils.pos_closing_print import (
...
class TestPOSClosingPrint(FrappeTestCase):
	@patch("omnipos.omnipos.utils.pos_closing_print.frappe.get_all")
	...
	@patch("omnipos.omnipos.utils.pos_closing_print._fetch_items_for_targets")
