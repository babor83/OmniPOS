...
frappe.ui.form.on("Omnilab Branding", {
...
function verify_master_key(frm) {
	...
	frappe.call({
		method: "omnipos.omnipos.doctype.brainwise_branding.brainwise_branding.verify_master_key",
		args: {
...
function show_master_key_help() {
	const help_html = `
		<div class="master-key-help">
			...
			<p>The Omnilab branding is protected by a cryptographic master key system.</p>
			...
			<div class="alert alert-warning">
				...
				Contact Omnilab support at <a href="mailto:support@omnilabes.com">support@omnilabes.com</a>
			</div>
		</div>
	`;
...
function show_tampering_stats() {
	frappe.call({
		method: "omnipos.api.branding.get_tampering_stats",
		callback: function (r) {
			if (r.message) {
				...
				const stats_html = `
					<div class="tampering-stats">
						...
						<p class="text-muted">View detailed logs in <a href="/app/error-log?title=Omnilab%20Branding">Error Log</a></p>
					</div>
				`;
