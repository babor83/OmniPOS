...
from omnipos.omnipos.doctype.pos_coupon.pos_coupon import (
	_get_customer_coupon_usage_count,
)


class TestPOSCoupon(unittest.TestCase):
	@patch("omnipos.omnipos.doctype.pos_coupon.pos_coupon.frappe.get_meta")
	@patch("omnipos.omnipos.doctype.pos_coupon.pos_coupon.frappe.db")
