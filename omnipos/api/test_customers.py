...
from omnipos.api.customers import (
...
class TestCustomersAPI(unittest.TestCase):
	@patch("omnipos.api.customers.frappe.logger")
	@patch("omnipos.api.customers.frappe.get_all")
	@patch("omnipos.api.customers.frappe.db")
	...
	@patch("omnipos.api.customers.frappe.get_cached_value")
	@patch("omnipos.api.customers.frappe.get_all")
	...
	@patch(
		"omnipos.api.customers.frappe.local",
		new=Mock(form_dict={"company": "Company A", "pos_profile": "POS-A"}),
	)
	@patch(
		"omnipos.api.customers.frappe.flags",
		new=Mock(omnipos_customer_company=None, omnipos_customer_pos_profile=None),
	)
	...
	@patch("omnipos.api.customers.frappe.get_doc")
	@patch("omnipos.api.customers.get_default_loyalty_program_from_settings")
	@patch("omnipos.api.customers.frappe.has_permission")
