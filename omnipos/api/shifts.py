...
from omnipos.api.utilities import get_wallet_payment_modes
...
def get_closing_shift_data(opening_shift):
	...
	from omnipos.omnipos.doctype.pos_closing_shift.pos_closing_shift import make_closing_shift_from_opening
...
def submit_closing_shift(closing_shift):
	...
	from omnipos.omnipos.doctype.pos_closing_shift.pos_closing_shift import (
