...
def create_customer(
	...
	frappe.flags.omnipos_customer_company = company
	frappe.flags.omnipos_customer_pos_profile = pos_profile
	try:
		customer.insert()
	finally:
		frappe.flags.omnipos_customer_company = None
		frappe.flags.omnipos_customer_pos_profile = None
...
def _get_customer_assignment_context():
	...
	company = getattr(frappe.flags, "omnipos_customer_company", None)
	pos_profile = getattr(frappe.flags, "omnipos_customer_pos_profile", None)
