...
try:
	...
	from omnipos.overrides.pricing_rule import patch_get_other_conditions
...
try:
	...
	from omnipos.overrides.frappe_compat import patch_round_floats_in_signature
...
try:
	...
	from omnipos.overrides.packed_item import patch_packed_item_keying
...
try:
	...
	from omnipos.overrides.rounding_compat import patch_round_floats_in_compat
