...
def patch_round_floats_in_signature(document_class):
	...
	if getattr(document_class, "_omnipos_round_floats_signature_patched", False):
		return
	...
	document_class._omnipos_original_round_floats_in = original
	document_class.round_floats_in = round_floats_in
	document_class._omnipos_round_floats_signature_patched = True
