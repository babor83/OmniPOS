...
def patch_round_floats_in_compat(document_module):
	...
	if getattr(document_cls, "_omnipos_round_floats_in_compat_patched", False):
		return
	...
	document_cls._omnipos_original_round_floats_in = original_round_floats_in
	document_cls.round_floats_in = _patched_round_floats_in
	document_cls._omnipos_round_floats_in_compat_patched = True
