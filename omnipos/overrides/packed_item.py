...
def patch_packed_item_keying(packed_item_module):
	...
	if getattr(packed_item_module, "_omnipos_packed_item_keying_patched", False):
		return
	...
	packed_item_module._omnipos_original_get_indexed_packed_items_table = original_get_indexed
	packed_item_module._omnipos_original_add_packed_item_row = original_add_row
	...
	packed_item_module._omnipos_packed_item_keying_patched = True
