...
def _get_post_change_gl_entries_setting():
	...
	Since omnipos has its own 'POS Settings' doctype (non-singleton) that overrides
...
class CustomSalesInvoice(SalesInvoice):
	...
	def validate_pos_paid_amount(self):
		...
		"""
		if getattr(self.flags, "omnipos_redeemed_customer_credit", 0) or getattr(
			self.flags, "omnipos_credit_sale", 0
		):
